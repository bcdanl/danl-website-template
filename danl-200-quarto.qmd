...
format: 
  html:
    ...
    highlight-style: espresso        # atom-one tango espresso   # https://quarto.org/docs/output-formats/html-code.html#highlighting
---
...
Let me add a code chunk:

```{r}
# below command is not meaningful
this <- "that" # this is a R command
that <- "this"
